...
pub contract ERC6358NFTExample: NonFungibleToken, IERC6358Token{
    ...
    // Omniverse NFT
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, ERC6358Protocol.ERC6358Token {
        pub let id: UInt64;
    ...
    pub fun omniverseMint(otx: AnyStruct{ERC6358Protocol.OmniverseTokenProtocol}) {
